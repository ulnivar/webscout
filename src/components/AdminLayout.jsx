...
const navItems = [
  ...
  },
  {
    ...
    icon: <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M5.25 14.25h13.5m-13.5 0a3 3 0 01-3-3m3 3a3 3 0 100 6h13.5a3 3 0 100-6m-13.5 0v-1.5m13.5 1.5v-1.5m0 0a3 3 0 01-3-3m3 3v-1.5m-13.5 1.5v-1.5m0 0a3 3 0 013-3m-3 3H3m16.5 0H21" /></svg>,
  },
  {
    ...
    <div className="layout">
      ...
      <aside className="sidebar">
        <div className="sidebar-logo">
          <Logo size={28} />
          <span style={{ fontSize: '10px', background: 'rgba(99,102,241,0.15)', color: 'var(--accent)', padding: '2px 7px', borderRadius: '4px', fontFamily: 'var(--font-body)', fontWeight: 700, letterSpacing: '0.5px' }}>
            ROOT
          </span>
        </div>
        ...
        <div className="sidebar-footer">
          <div className="sidebar-user">
            <div className="sidebar-avatar" style={{ background: 'rgba(248,113,113,0.12)', color: 'var(--red)' }}>
